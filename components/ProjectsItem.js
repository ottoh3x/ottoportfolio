...
function ProjectsItem({src,title}) {
  return (
    ...
    <div className="shadow-2xl ">
      <div className="md:max-w-md bg-[#ffffff0a] p-4 rounded-lg w-full hover:translate-y-[-0.2rem] transition-all ease-in-out duration-600 cursor-pointer">
        ...
        <button className="bg-green-600 text-gray-200 p-3 my-2 text-center mx-auto w-full hover:translate-y-[-0.1rem] transition-all ease-in-out duration-700 hover:shadow-2xl">Visit Website</button>
      </div>
    </div>
  )
}
