...
function About() {
  return (
    <>
      ...
      <h1 className=" text-3xl bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-green-400 to-green-700">About</h1>
        ...
        <h1 className="text-3xl bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-green-400 to-green-700">Skills</h1>
