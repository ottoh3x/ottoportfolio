...
function Services() {
  return (
    <div className="container mx-auto p-6  my-6 0  rounded-lg shadow-lg">
      ...
      <h1 className="text-gray-100 text-center text-2xl font-normal p-4">What can i do for you</h1>
      <div className="grid md:grid-cols-3 gap-4 lg:w-2/3 items-center mx-auto">
        <div className="">
